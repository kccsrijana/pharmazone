"""
Django settings for pharmazone project.
...
SECRET_KEY = 'django-insecure-z$iyhybu2788f9%(1)l)kfc93gnqz$dpw#_dzpeavisqyx_97s'
...
WSGI_APPLICATION = 'pharmazone.wsgi.application'
